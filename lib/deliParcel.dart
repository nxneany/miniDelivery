...
class Deliparcel extends StatefulWidget {
  const Deliparcel({super.key});

  @override
  State<Deliparcel> createState() => _DeliparcelState();
}

class _DeliparcelState extends State<Deliparcel> {
  int currentIndex = 2; // เริ่มต้นที่แท็บ "สินค้าที่นำส่ง"
